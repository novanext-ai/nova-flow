...
async finishOperation() : Promise<void> {
    await TAURI_INVOKE("finish_operation");
},
...
export type SoundTheme = "nova" | "marimba" | "pop" | "custom"
/**
